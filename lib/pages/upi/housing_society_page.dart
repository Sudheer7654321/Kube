...
class HousingSocietyPage extends StatefulWidget {
  const HousingSocietyPage({super.key});

  @override
  State<HousingSocietyPage> createState() => _HousingSocietyPageState();
}

class _HousingSocietyPageState extends State<HousingSocietyPage> {
